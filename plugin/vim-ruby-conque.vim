...
function! RunRspecCurrentLineConque()
  call RunSingleConque(GetRubyConqueRspecCommand() . " -Ispec  " . bufname('%') . " -l "  . line('.') . " --color")
endfunction

function! RunRspecCurrentFileConque()
  call RunSingleConque(GetRubyConqueRspecCommand() . " -Ispec " . bufname('%') . " --color")
endfunction
...
function! RunCucumberCurrentFileConque()
  call RunSingleConque(GetRubyConqueCucumberCommand() . " -Ispec " . bufname('%'))
endfunction
